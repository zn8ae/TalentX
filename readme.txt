...
runner.sh will automate spark map-reduce job to produce recommendation table in the interval of 30 seconds and inject the newly produced table into database.
...
#Be sure to check if not login, view detail